...
func (in *PodStatus) DeepCopyObject() runtime.Object {
    if c := in.DeepCopy(); c != nil {
        return c
    }
    return nil
...
func (in *PodStatus) GetObjectKind() schema.ObjectKind {
    return in
}

func (in *PodStatus) SetGroupVersionKind(gvk schema.GroupVersionKind) {
    in.gvk = gvk
}

func (in *PodStatus) GroupVersionKind() schema.GroupVersionKind {
    return in.gvk
}
